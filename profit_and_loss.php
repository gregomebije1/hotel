...
if(isset($_REQUEST['action']) && ($_REQUEST['action'] =="Print")) {
  ...
  if (isset($_REQUEST['action']) && ($_REQUEST['action'] == 'Process')) {
    ...
    <table>
     ...
     print_accounts($sql, $title, $sdate, $edate, $con);

     $net_sales = $sales - $charges;
     echo "<tr><td><b><i>Net Sales</i></b></td><td>&nbsp;</td><td><b>" 
      . number_format($net_sales, 2) . "</b></td></tr>";
    
     echo "<tr><td>&nbsp;</td></tr>
     <tr><td><b>Less Cost of goods sold:</b></td></tr>";
